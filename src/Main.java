...
public class Main{
        ...
        public static String[] heroesAttackType = {"Physical", "Magical", "Chort", "Medik",
                "berserk", "Cuvalda", "Lucky", "Golem"};
    ...
    public static void printStatistics () {
        ...
        for (int i = 0; i < heroesHealth.length; i++) {
            System.out.println(heroesAttackType[i] +
                    " health: " + heroesHealth[i] + " (" + heroesDamage[i] + ")"); //ВСЕ МОГУ ИДТИ СПАТЬ, было ооочень тяжело
        }
    }
}
